<#
.SYNOPSIS
    One-click installer and launcher for Entra Conditional Access Policy Backup via Microsoft Graph
...
Write-Host "    Entra Conditional Access Policy Backup via Microsoft Graph" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/entra-conditional-access-policy-backup.ps1"
